...
COMMANDS=[("mount","Core mount utility",True),("findmnt","Mount verification",True),("systemctl","Job scheduler",True),("ssh","Remote access",True),("scp","Hyper-V transfer",False),("sshpass","Password SSH fallback",False),("mount.nfs","NFS support",False),("mount.cifs","SMB/CIFS support",False),("iscsiadm","iSCSI support",False),("govc","VMware connector",False),("qemu-img","Disk conversion",False)]
def report():
    ensure_dirs();rows=[]
